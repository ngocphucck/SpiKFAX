...
def load_dataset(dataset='cifar10', datapath='cifar10/data', batch_size=128, \
    ...
    if dataset == 'cifar10_spike':
        from torchvision import datasets
        data_path = '/home/40430926@ecit.qub.ac.uk/SNN-optimization/data/data/static/CIFAR10'
        ...
        test_transform = transforms.Compose([
            transforms.ToTensor()])
        trainset = datasets.CIFAR10(data_path, train=True, download=False, transform=transform)
        testset = datasets.CIFAR10(data_path, train=False, download=False, transform=test_transform)
